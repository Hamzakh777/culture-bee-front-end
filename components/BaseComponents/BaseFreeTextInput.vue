<template>
	<div>
		...
		>
			...
			/>
			<img
				class="h-4 absolute right-0 top-1/2 -transform-y-50 transition-all transition-100 ease-out cursor-pointer"
				:class="{
		...
		<base-input-error-message v-if="isError" :error-type="'required'" />
	</div>
</template>
