<template>
	<div class="py-12">
		...
		<div class="mt-4 mb-6">
			<div class="flex flex-row items-center">
				...
				<div class="pl-6 text-xs">
					...
					<base-input-error-message
						v-if="
							!$v.acceptTermsAndPrivacyUse.required &&
								$v.acceptTermsAndPrivacyUse.$error
						"
						class="-ml-4 pt-3"
		...
		<!-- sign up button -->
		<div
			class="flex flex-col items-center md:flex-row-reverse md:justify-between"
		>
			<base-ajax-button
			...
			<button class="secondary-btn" @click.prevent="previousStep">
				Back
			</button>
		</div>
	</div>
