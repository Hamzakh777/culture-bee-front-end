<template>
	<div class="py-6 mt-6">
		...
		<button
			:class="{
				'bg-gray-to-black text-white': type.value === role,
				'bg-transparent text-gray-800': type.value !== role
			}"
		...
		<base-input-error-message
			...
			:error-type="'required'"
		/>
		<button @click.prevent="validate" class="primary-btn block py-4 w-full">
			next
		</button>
	</div>
</template>
